...
import { Topbar, AdvantageOpportunityCard, ExportButtons } from '../_components/components'
...
// Opportunities — the ranked list (entry to the per-topic workspace). Restored
// as its own screen after the aggregate dashboard was retired; cards open the
...
export default function OpportunitiesPage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        // Empty table + we have scanned posts → materialize once, then re-read.
  ...
  return (
    <>
      <Topbar title="Opportunities" posts={scan.posts}>
        <ExportButtons
