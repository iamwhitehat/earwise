...
import { AdvantageOpportunityCard } from './components'
...
// Today — the triage inbox: a prioritized queue of decisions (hot signals,
// opportunities, the pipeline nudge). Extracted from app/today/page.tsx so it
// renders as the default tab of the consolidated Home surface.
const TOP_OPPS = 3
      ...
      {!loading && topOpps.length > 0 && (
        <section className="section">
          <div className="section-head">
            ...
            <Link href="/today?view=opportunities" className="btn btn-ghost btn-sm" style={{ marginLeft: 'auto', textDecoration: 'none' }}>
      ...
      {nothing && (
        <div className="card empty fade-in">
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/today?view=opportunities" className="btn btn-ghost" style={{ textDecoration: 'none' }}>
